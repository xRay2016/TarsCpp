...
namespace tars
{
    ...
    public:
        ...
        static string MD5()
        {
            return "b19ed9ada6d10639715d4c22ba6623ad";
        }
        EndpointF()
        {
            resetDefautlt();
        ...
        tars::JsonValueObjPtr writeToJson() const
        {
            ...
            p->value["subset"] = tars::JsonOutput::writeJson(subset);
            return p;
        }
        ...
        void readFromJson(const tars::JsonValuePtr & p, bool isRequire = true)
        {
            ...
            tars::JsonInput::readJson(subset,pObj->value["subset"], false);
        }
        ...
        ostream& displaySimple(ostream& _os, int _level=0) const
        {
            ...
            _ds.displaySimple(authType, true);
            _ds.displaySimple(subset, false);
            return _os;
        }
    public:
        std::string host;
    ...
    {
        return l.host == r.host && l.port == r.port && l.timeout == r.timeout && l.istcp == r.istcp && l.grid == r.grid && l.groupworkid == r.groupworkid && l.grouprealid == r.grouprealid && l.setId == r.setId && l.qos == r.qos && l.bakFlag == r.bakFlag && l.weight == r.weight && l.weightType == r.weightType && l.authType == r.authType && l.subset == r.subset;
    }
    inline bool operator!=(const EndpointF&l, const EndpointF&r)
    {
        return !(l == r);
    ...
    inline bool operator<(const EndpointF&l, const EndpointF&r)
    {
        ...
        if(l.subset != r.subset)  return (l.subset < r.subset);
        return false;
    }
    inline bool operator<=(const EndpointF&l, const EndpointF&r)
    {
    ...
    struct SubsetConf : public tars::TarsStructBase
    {
    public:
        static string className()
        {
            return "tars.SubsetConf";
        }
        static string MD5()
        {
            return "38333f4e414d924ab2e9c945f92f8477";
        }
        SubsetConf()
        {
            resetDefautlt();
        ...
        {
            _os.write(enable, 0);
            _os.write(ruleType, 1);
            _os.write(ruleData, 2);
        }
        template<typename ReaderT>
        void readFrom(tars::TarsInputStream<ReaderT>& _is)
        {
            resetDefautlt();
            _is.read(enable, 0, true);
            _is.read(ruleType, 1, true);
            _is.read(ruleData, 2, true);
        }
        tars::JsonValueObjPtr writeToJson() const
        {
            tars::JsonValueObjPtr p = new tars::JsonValueObj();
            p->value["enable"] = tars::JsonOutput::writeJson(enable);
            p->value["ruleType"] = tars::JsonOutput::writeJson(ruleType);
            p->value["ruleData"] = tars::JsonOutput::writeJson(ruleData);
            return p;
        }
        string writeToJsonString() const
        {
        ...
        void readFromJson(const tars::JsonValuePtr & p, bool isRequire = true)
        {
            ...
            tars::JsonValueObjPtr pObj=tars::JsonValueObjPtr::dynamicCast(p);
            tars::JsonInput::readJson(enable,pObj->value["enable"], true);
            tars::JsonInput::readJson(ruleType,pObj->value["ruleType"], true);
            tars::JsonInput::readJson(ruleData,pObj->value["ruleData"], true);
        }
        void readFromJsonString(const string & str)
        {
            readFromJson(tars::TC_Json::getValue(str));
        ...
        ostream& display(ostream& _os, int _level=0) const
        {
            ...
            _ds.display(ruleType,"ruleType");
            _ds.display(ruleData,"ruleData");
            return _os;
        }
        ostream& displaySimple(ostream& _os, int _level=0) const
        {
            ...
            _ds.displaySimple(ruleType, true);
            _ds.displaySimple(ruleData, false);
            return _os;
        }
    public:
        tars::Bool enable;
    ...
    inline bool operator==(const SubsetConf&l, const SubsetConf&r)
    {
        return l.enable == r.enable && l.ruleType == r.ruleType && l.ruleData == r.ruleData;
    }
    inline bool operator!=(const SubsetConf&l, const SubsetConf&r)
    {
        return !(l == r);
    }
    inline ostream& operator<<(ostream & os,const SubsetConf&r)
    {
        os << r.writeToJsonString();
        return os;
    }
    inline istream& operator>>(istream& is,SubsetConf&l)
    {
        std::istreambuf_iterator<char> eos;
        std::string s(std::istreambuf_iterator<char>(is), eos);
        l.readFromJsonString(s);
